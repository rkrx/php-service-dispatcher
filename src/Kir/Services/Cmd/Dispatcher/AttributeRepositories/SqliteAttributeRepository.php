...
class SqliteAttributeRepository implements AttributeRepository {
	...
	public function __construct(PDO $pdo) {
		...
		$this->selectServices = $pdo->prepare('SELECT service_key FROM services WHERE date(service_last_run, "-"||service_timeout||" seconds") < service_last_run ORDER BY MAX(service_last_try, service_last_run) ASC;');
